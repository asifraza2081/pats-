    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?= APP_URL ?>/projects">Open Projects</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= APP_URL ?>/result">Check Result</a>
                </li>
            </ul>
            <ul class="navbar-nav">
                <?php if (\App\Core\Auth::check()): ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?= APP_URL ?>/dashboard"><i class="bi bi-speedometer2 me-2"></i>Dashboard</a></li>
                            <li><a class="dropdown-item" href="<?= APP_URL ?>/profile"><i class="bi bi-person me-2"></i>My Profile</a></li>
                            <li><a class="dropdown-item" href="<?= APP_URL ?>/applications"><i class="bi bi-file-earmark-text me-2"></i>My Applications</a></li>
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item">
                        <a class="btn btn-light btn-sm ms-2" href="<?= APP_URL ?>/register">Register</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
