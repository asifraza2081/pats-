...
@section('page-title', 'Edit Batch BATCH-' . $batch->batch_number)
...
<div class="card-body p-4">
    ...
    <form method="POST" action="{{ route('admin.batches.update',$batch) }}">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3"><label class="form-label fw-semibold">Batch No. *</label><input type="number" name="batch_number" class="form-control" value="{{ old('batch_number',$batch->batch_number) }}" min="1" required></div>
